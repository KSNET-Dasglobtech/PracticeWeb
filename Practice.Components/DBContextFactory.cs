...
namespace PracticeWeb.Components
{
    ...
    /// This code was downloaded as it is from http://www.west-wind.com/weblog/posts/2008/Feb/05/Linq-to-SQL-DataContext-Lifetime-Management
    /// The only modifications were changes to usage of ObjectDataContext from DataContext
    /// </summary>
    ...
    public class DBContextFactory
    {
        ...
        public static TDataContext GetDataContext<TDataContext>() where TDataContext : DbContext, new()
        {
        ...
        public static TDataContext GetDataContext<TDataContext>(string connectionString) where TDataContext : DbContext, new()
        {
        ...
        public static TDataContext GetWebRequestScopedDataContext<TDataContext>() where TDataContext : DbContext, new()
        {
        ...
        public static TDataContext GetWebRequestScopedDataContext<TDataContext>(string key) where TDataContext : DbContext, new()
        {
        ...
        public static TDataContext GetWebRequestScopedDataContext<TDataContext>(string key, string connectionString) where TDataContext : DbContext, new()
        {
        ...
        public static TDataContext GetThreadScopedDataContext<TDataContext>() where TDataContext : DbContext, new()
        {
