...
$(function() {
    ...
    require(
        ...
        function (ec, JIO) {
            ...
            // Init
            var sales = ec.init(document.getElementById('sales'), JIO);
            var visits = ec.init(document.getElementById('visits'), JIO);
            var plans = ec.init(document.getElementById('plans'), JIO);
