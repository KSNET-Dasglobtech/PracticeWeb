    ...
    var hot_html_cells_data = [
        {
            ...
            title: "<a href='http://themeforest.net/item/JIO-responsive-web-application-kit/13080328' target='_blank'>JIO - Responsive Web Application Kit</a>",
            description: "JIO is one of the best application templates ever built. Very flexible and clean admin template based on Bootstrap and Less. Available in 4 different layouts.",
